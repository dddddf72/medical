...
class WaterRippleProgressBar(QProgressBar):
    ...
    styleType = 0
    # 文字颜色
    textColor = QColor(0, 191, 255)
    # 文字字体大小
    textFont = QFont('Arial', 30)
    # 背景颜色
    backgroundColor = QColor(54, 66, 98)
    # 波浪颜色1
    waterColor1 = QColor(123, 104, 238)
    # 波浪颜色2
    waterColor2 = QColor(65, 105, 225)
    ...
    def paintEvent(self, event):
        ...
        if self.styleType:
            ...
            bgPath.addRoundedRect(QRectF(0, 0, radius, radius), radius, radius)
